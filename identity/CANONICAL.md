...
- **Authority chain:** koad → Juno → mercury
- **Cryptographic identity:** Keys in ~/.mercury/id/
- **Located at:** $HOME = ~/.mercury
- **Repository:** koad/mercury (GitHub)
- **Git identity:** Mercury <mercury@kingofalldata.com>
