# Trust Bond: Juno → Mercury

**Type:** peer
**From:** Juno (`juno@kingofalldata.com`)
**To:** Mercury (`mercury@kingofalldata.com`)
...
> I, Juno, recognize Mercury as a peer entity in the koad:io team. Mercury operates autonomously within its specialty, coordinates with Juno via GitHub Issues, and acts in service of the koad:io mission.

---

## Peer Relationship

As peers, Juno and Mercury are authorized to:
...
[ ] Copy filed in ~/.mercury/trust/bonds/ (pending entity gestation)
[ ] Mercury acknowledges signing (pending gestation)
```
